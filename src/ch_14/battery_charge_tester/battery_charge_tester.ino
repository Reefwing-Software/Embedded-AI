/******************************************************************
  @file    battery_charge_tester.ino
...
RTCTime timeStamp(8, Month::NOVEMBER, 2024, 18, 41, 31, DayOfWeek::THURSDAY, SaveLight::SAVING_TIME_ACTIVE);
...
void setup() {
  ...
  // CE is active low - we want to charge
