...
# DAC VOLTAGE VS BATTERY DISCHARGE CURRENT (RSENSE = 1 Ω)
...
image_name = 'f14032.pdf'
image_path = os.path.join(image_folder, image_name)

# Define the data folder and file paths
data_folder = os.path.expanduser("~/Documents/GitHub/NSP-Embedded-AI/data/ch_14")
file_path_3_7V = os.path.join(data_folder, "load_3_7V.txt")
file_path_4_2V = os.path.join(data_folder, "load_4_2V.txt")
...
# Limit the x-axis to 0-5 V and y-axis to 900 mA
plt.xlim(0.0, 5.0)
plt.ylim(0, 900)
