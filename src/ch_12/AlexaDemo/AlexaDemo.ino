// This example demonstrates basic speech recognition on the Arduino Nicla Voice.
// You can find it in the Arduino IDE under:
// File > Examples > NDP > AlexaDemo
// The sketch runs a prebuilt hot word detection model and provides visual feedback
// when the wake word is detected, allowing you to verify that the board, firmware,
// and neural audio processor are working correctly.
