...
INPUT_FOLDER = Path("~/Documents/GitHub/NSP-Embedded-AI/data/ch_12/GAN").expanduser()
IMAGE_FOLDER = Path("~/Documents/GitHub/NSP-Embedded-AI/images/ch_12_final").expanduser()
