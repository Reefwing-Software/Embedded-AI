...
circle = plt.Circle((offset_x, offset_y), radius, color='black', fill=False, linestyle='--')
...
plt.xlim(-0.7 + offset_x, 0.7 + offset_x)
plt.ylim(-0.7 + offset_y, 0.7 + offset_y)
