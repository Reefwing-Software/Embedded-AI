 ...
 */
 ...
 // Note: PIN_MISO = 21 if needed for read support, but ST7789 is usually write-only
 #define PIN_BL     17  // Backlight control
 #define PIN_DC     18  // Data/Command
 #define PIN_RESET  19  // LCD Reset
 #define PIN_CS     20  // Chip Select
 #define PIN_DIN    26  // Data In (MOSI)
 #define PIN_CLK    27  // Clock (SCLK)
 
 #define SPI_POLARITY 1 // default is 0, some displays require polarity 1
