...
# First LSTM layer with increased units and return_sequences=True to pass the sequence to the next LSTM
...
# Final dense layers for outputs
outputs = {
...
# Build the model
model = tf.keras.Model(inputs, outputs, name="music_rnn_model_v2")
...
train_dataset_path = data_folder / "train_seq_ds.tfrecord"
val_dataset_path = data_folder / "val_seq_ds.tfrecord"
test_dataset_path = data_folder / "test_seq_ds.tfrecord"
