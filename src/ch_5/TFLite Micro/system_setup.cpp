...
// Ensure compatibility with Arduino Nano 33 BLE and Nicla Vision
#if defined(ARDUINO) && !(defined(ARDUINO_NICLA_VISION) || defined(ARDUINO_ARDUINO_NANO33BLE))
#define ARDUINO_EXCLUDE_CODE
#endif  // defined(ARDUINO) && !(defined(ARDUINO_NICLA_VISION) || defined(ARDUINO_ARDUINO_NANO33BLE))
