...
constexpr PinName kI2S_BIT_CLK = NC;       // Not connected on Nicla Vision
constexpr PinName kI2S_LR_CLK = NC;        // Not connected on Nicla Vision
constexpr PinName kI2S_DATA_IN = NC;       // Not connected on Nicla Vision
constexpr PinName kI2S_DATA_OUT = NC;      // Not connected on Nicla Vision
constexpr uint32_t kI2S_IRQ_PRIORITY = 7; // Not applicable

constexpr uint32_t kI2C_CLOCK = 100000;

constexpr pin_size_t kBUTTON_GPIO = NC; // No GPIO button on Nicla Vision

constexpr pin_size_t kLED_DEFAULT_GPIO = LED_BUILTIN; // Built-in LED on Nicla Vision
