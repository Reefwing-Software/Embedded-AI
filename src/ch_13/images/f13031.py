...
#
# DAC VOLTAGE VS BATTERY DISCHARGE CURRENT (RSENSE = 4R7 Ω)
...
image_name = 'f13031.pdf'
image_path = os.path.join(image_folder, image_name)

# Define the data folder and file paths
data_folder = os.path.expanduser("~/Documents/GitHub/NSP-Embedded-AI/data/ch_13")
file_path_3_7V = os.path.join(data_folder, "sweep_3_7V.txt")
file_path_4_2V = os.path.join(data_folder, "sweep_4_2V.txt")
...
# Limit the x-axis to 0-5 V and y-axis to 175 mA
plt.xlim(0.0, 5.0)
plt.ylim(0, 175)
