...
# Define the hyperparameters in a configuration dictionary for Trial 5
config = {
    'trial': 5,
    'initial_constant_value': 0.4,
    'constant_bounds': (0.1, 1.0),
    'initial_length_scales': [0.0005, 0.001, 0.002],
    'length_scale_bounds': (0.0001, 0.1),
    'max_iter': 20000,
...
grid_search = GridSearchCV(pipeline, param_grid_trial_5, cv=config['cv_folds'], n_jobs=-1, verbose=2)
